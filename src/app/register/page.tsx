...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        toast.success("Registration successful! Welcome to Gateway Holidays.");
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-indigo-50 to-blue-100 p-4 sm:p-6 lg:p-8">
      {/* Background Shapes */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-20 -left-20 h-96 w-96 rounded-full bg-gradient-to-br from-blue-300/30 to-indigo-400/40 blur-3xl"></div>
        <div className="absolute bottom-1/3 -right-32 h-80 w-80 rounded-full bg-gradient-to-tl from-purple-400/25 to-blue-500/35 blur-2xl"></div>
        <div className="absolute left-1/4 -bottom-32 h-72 w-72 rounded-full bg-gradient-to-tr from-cyan-300/20 to-indigo-300/30 blur-3xl"></div>
      </div>

      <div className="relative z-10 flex w-full max-w-5xl flex-col overflow-hidden rounded-3xl border border-white/40 bg-white/90 shadow-2xl backdrop-blur-3xl lg:flex-row-reverse">
        {/* Right Side - Register Form */}
        <div className="w-full space-y-6 p-8 sm:space-y-8 sm:p-10 md:p-12 lg:w-1/2">
          <div className="text-center">
            <h1 className="mb-2 text-4xl font-bold text-gray-800">Register</h1>
            <p className="text-base text-gray-600 sm:text-lg">
              Create an account for your next adventure
            </p>
          </div>
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="mx-4 flex-shrink text-sm font-medium text-gray-600">Or</span>
            <div className="flex-grow border-t border-gray-300"></div>
          </div>
        ...
        {/* Left Side (now on left because of reverse) - Branding */}
        <div className="relative hidden w-full bg-gradient-to-br from-indigo-600 to-blue-800 lg:flex lg:w-1/2">
          <div className="absolute inset-0 opacity-40"></div>
          <div className="relative z-10 flex flex-col items-center justify-center p-12 text-center text-white">
            <h2 className="mb-4 text-4xl font-bold text-black">Join Us Today</h2>
            <p className="mb-6 text-xl opacity-90 text-black">
              Start your journey with Gateway Holidays.
            </p>
            <div className="mt-8 space-y-4 text-left">
               <div className="flex items-center space-x-3">
                ...
                <span className="text-black">Manage your bookings easily</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
                  <span className="text-sm font-bold">✓</span>
                </div>
                <span className="text-black">Save your favorite destinations</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
                  <span className="text-sm font-bold">✓</span>
