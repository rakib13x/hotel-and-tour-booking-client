...
import { AlertCircle, Home, Mail, Phone, RefreshCw } from "lucide-react";
import { useRouter, useSearchParams } from "next/navigation";
import { Suspense, useEffect, useState } from "react";

function VisaFailedContent() {
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-gray-600">
            Your visa application payment could not be processed
          </p>
        </div>
          ...
          <Card className="border-gray-200 bg-gray-50">
            <CardContent className="p-6">
              ...
              <p className="mb-3 text-sm text-gray-600">
                If you're experiencing issues with payment, please don't
...
export default function VisaFailedPage() {
  return (
    <Suspense
      fallback={
